{config, ...}:
let
  enabled = config.nixvim.completion.plugin == "cmp";
in
{
  config = {
    plugins.cmp.enable = enabled;
    ...
    # sources
    plugins.cmp-path.enable = enabled;
    plugins.cmp-buffer.enable = enabled;
    plugins.cmp-nvim-lsp.enable = enabled;
    plugins.cmp-cmdline.enable = enabled;
    plugins.cmp.autoEnableSources = enabled;
    ...
    # snippet
    plugins.luasnip.enable = enabled;
    plugins.cmp_luasnip.enable = enabled;
    ...
    # kind
    plugins.lspkind.enable = enabled;
    plugins.lspkind.cmp.enable = enabled;
